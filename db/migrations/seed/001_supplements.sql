...
INSERT INTO supplement_types (id, name, timing, training_day_only, active, cycle_id, target_dose, target_unit, instructions, sort_order) VALUES
  ...
  ('l-theanine',     'L-Theanine',                'morning',       false, true, NULL,                 200,   'mg',           'Pairs well with caffeine for calm focus. No cycling needed.',                            35),
...
INSERT INTO supplement_brands (id, type_id, brand_id, product_name, serving_dose, serving_unit, units_per_serving, unit_name, form, instructions, url, price_per_serving, subscription_discount) VALUES
  ...
  -- L-Theanine
  ('theanine-nutricost',    'l-theanine',   'nutricost',         'L-Theanine 200mg',                   200,    'mg',           1, 'capsule', 'pill',  '120 capsules.',                                         'https://nutricost.com/products/nutricost-l-theanine-200mg-capsules', 0.08, NULL),
  -- Omega-3
  ...
  ('d3-nutricost',          'vitamin-d3',   'nutricost',         'Vitamin K2 + Vitamin D3 Softgels',   5000,   'IU',           1, 'softgel', 'pill',  '120 softgels. Also provides 100mcg K2 (MK-7).',        'https://nutricost.com/products/nutricost-vitamin-k2-100mcg-vitamin-d3-5000iu-120-softgels', 0.16, NULL),
  ...
  ('k2-nutricost',          'vitamin-k2',   'nutricost',         'Vitamin K2 + Vitamin D3 Softgels',  100,    'mcg',          1, 'softgel', 'pill',  '120 softgels. MK-7. Also provides 5000 IU D3.',        'https://nutricost.com/products/nutricost-vitamin-k2-100mcg-vitamin-d3-5000iu-120-softgels', 0.16, NULL),

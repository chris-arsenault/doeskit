...
INSERT INTO supplement_types (id, name, timing, training_day_only, cycle_id, target_dose, target_unit, instructions, sort_order) VALUES
  ...
  ('post-protein',   'Post-Workout Protein',      'post_workout',  false, NULL,                 38,    'g protein',    'Post-workout or meal replacement. Target 35-42g.',                                      170),
...
INSERT INTO supplement_brands (id, type_id, brand, product_name, serving_dose, serving_unit, units_per_serving, unit_name, form, instructions) VALUES
  ('creatine-thorne-agpc',  'creatine',     'Thorne',              'Creatine + Alpha GPC',               5,      'g',            1, 'scoop',   'scoop', 'Also provides 600mg Alpha-GPC per scoop. Watermelon Lemonade flavor.'),
  ('creatine-thorne',       'creatine',     'Thorne',              'Creatine',                           5,      'g',            1, 'scoop',   'scoop', 'Pure micronized creatine monohydrate, unflavored.'),
  ...
  ('collagen-thorne',       'collagen',     'Thorne',              'Collagen Plus',                      13,     'g',            1, 'scoop',   'scoop', 'Also provides NR 125mg, ceramides, betaine. Passion Berry flavor.'),
  ('collagen-vp',           'collagen',     'Vital Proteins',      'Collagen Peptides',                  10,     'g',            1, 'scoop',   'scoop', 'Unflavored bovine hide Types I & III.'),
  ...
  ('casein-pescience',      'casein',       'PEScience',           'Select Multi-Purpose Unflavored',    23,     'g protein',    1, 'scoop',   'scoop', 'Whey + casein blend. 110 cal, 1g fat, 2g carb. Unflavored.'),
  ...
  ('preworkout-tl',         'pre-workout',  'Transparent Labs',    'Stim-Free Pre-Workout',              1,      'serving',      1, 'scoop',   'scoop', '8g citrulline, 4g beta-alanine, 2.5g betaine, 1g tyrosine. Informed Choice certified.'),
  ('preworkout-nc',         'pre-workout',  'Nutricost',           'Stim Free Preworkout',               1,      'serving',      1, 'scoop',   'scoop', '6g citrulline, 1.2g beta-alanine, 500mg NALT, 200mg Alpha GPC.'),
  ('intra-cdx-tl',          'intra-carb',   'Transparent Labs',    'Cyclic Dextrin',                     1,      'serving',      1, 'scoop',   'scoop', '25g highly branched cyclic dextrin per scoop.'),
  ('intra-pf',              'intra-carb',   'Precision Fuel',      'Carb & Electrolyte Drink Mix PF 30', 1,      'serving',      2, 'scoop',   'scoop', '30g carbs (maltodextrin:fructose 2:1), 500mg sodium per 2 scoops.'),
  ('intra-amino-momentous', 'intra-amino',  'Momentous',           'Vital Aminos',                       1,      'serving',      1, 'scoop',   'scoop', '9 EAAs, 2.5g leucine. NSF Certified for Sport.'),
  ('whey-tl',               'post-protein', 'Transparent Labs',    'Grass-Fed Whey Protein Isolate',     28,     'g protein',    1, 'scoop',   'scoop', 'Grass-fed American dairy. Stevia sweetened. Informed Choice certified.'),
  ('plant-thorne',          'post-protein', 'Thorne',              'Plant Protein (Chocolate)',           11,     'g protein',    1, 'scoop',   'scoop', 'Pea + rice + chia. 70 cal per scoop. NSF Certified for Sport.'),
  ('plant-orgain',          'post-protein', 'Orgain',              'Organic Protein + 50 Superfoods',    10.5,   'g protein',    1, 'scoop',   'scoop', 'Pea + rice + mung bean + chia. 80 cal per scoop.'),

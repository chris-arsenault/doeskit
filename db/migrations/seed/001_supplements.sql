...
INSERT INTO supplement_brands (id, type_id, brand, product_name, serving_dose, serving_unit, serving_size, form, instructions) VALUES
  ...
  ('casein-pescience',      'casein',      'PEScience',           'Select Multi-Purpose Unflavored',    23,     'g protein',    '1 scoop (29.5g)',   'scoop', 'Whey + casein blend. 110 cal, 1g fat, 2g carb. Unflavored, works for baking and smoothies.'),
